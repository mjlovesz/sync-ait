...
public class PluginClassId {
    ...
    public static final String AitIde_PluginId = "com.ascend.ait.ide";
    ...
    public static final String AisBench_ClassId = "com.ascend.ait.ide.action.AisBenchAction";
    public static final String Compare_ClassId = "com.ascend.ait.ide.action.CompareAction";
}
