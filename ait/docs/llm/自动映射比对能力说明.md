...
![使用说明步骤](image/%E8%87%AA%E5%8A%A8%E6%98%A0%E5%B0%84%E6%AF%94%E5%AF%B9%E8%83%BD%E5%8A%9B%E8%AF%B4%E6%98%8E/%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E%E6%AD%A5%E9%AA%A4.jpg)
...
* dump完成后model拓扑信息`model_tree.json`生成在`{DUMP_DIR}/{PID}_npu{x}`目录下
...
* dump完成后tensor信息生成在`{DUMP_DIR}/ait_dump/tensors/{PID}_{TID}`目录下
...
* --golden-path参数为第一步中 `torch_tensor`所在目录 `{DUMP_DIR}/{PID}_npu{x}/0/`
