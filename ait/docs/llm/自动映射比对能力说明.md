...
| LayerNormOperation | LayerNorm |
| LinearOperation | Linear |
| CommonLayer_outtensor0 | GLMBlock_output_0 (ChatGLM)<br>BloomBlock_output_0 (Bloom) |
| MlpGateLayerV2 | MLP (ChatGLM)<br>BloomMLP (Bloom) |
| RmsNormOperation | RMSNorm |
| SelfAttentionOperation | CoreAttention (ChatGLM)|
