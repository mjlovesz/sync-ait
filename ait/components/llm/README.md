...
- ait-llm 工具 whl：
  ...
  | ----- | ---------- | ---------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------- |
  | 0.2.1 | 2024/01/31 | arm        | 8.0.RC1   | [ait_llm-0.2.1-py3-none-linux_aarch64.whl](https://ais-bench.obs.cn-north-4.myhuaweicloud.com/compare/20240208/ait_llm-0.2.1-py3-none-linux_aarch64.whl)      | 27d495743e09b23870e3644077845e4f | [llm大模型推理精度工具功能说明_v0.2.1](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.1.md) |
  | 0.2.1 | 2024/01/31 | x86        | 8.0.RC1   | [ait_llm-0.2.1-py3-none-linux_x86_64.whl](https://ais-bench.obs.cn-north-4.myhuaweicloud.com/compare/20240208/ait_llm-0.2.1-py3-none-linux_x86_64.whl)        | 37ec005ec0f85799ca7c197eda7fc531 | [llm大模型推理精度工具功能说明_v0.2.1](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.1.md) |
  |       |            |            |           |                                                                                                                                                            |                                  |                                                                                             |
