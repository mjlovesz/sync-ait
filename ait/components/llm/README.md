...
- ait-llm 工具 whl：
  ...
  | ----- | ---------- | ---------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------- |
  | 0.2.2 | 2024/03/05 | arm        | 8.0.RC1.B106 | ait_llm-0.2.2-py3-none-linux_aarch64.whl                                                                                                                   |                                  | [llm大模型推理精度工具功能说明_v0.2.2](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.2.md) |
  | 0.2.2 | 2024/03/05 | x86        | 8.0.RC1.B106 | ait_llm-0.2.2-py3-none-linux_aarch64.whl                                                                                                                   |                                  | [llm大模型推理精度工具功能说明_v0.2.2](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.2.md) |
  |       |            |            |              |                                                                                                                                                            |                                  |                                                                                             |
