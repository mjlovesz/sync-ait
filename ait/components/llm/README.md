...
- ait-llm 工具 whl：
  ...
  | ----- | ---------- | ---------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------- |
  | 0.2.1 | 2024/01/31 | arm        | 8.0.RC1   | [ait_llm-0.2.1-py3-none-linux_aarch64.whl](https://ais-bench.obs.cn-north-4.myhuaweicloud.com/compare/20240202/ait_llm-0.2.1-py3-none-linux_aarch64.whl)      | e3ac2e79edc8dbd2f67dce0bab9169b0 | [llm大模型推理精度工具功能说明_v0.2.1](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.1.md) |
  | 0.2.1 | 2024/01/31 | x86        | 8.0.RC1   | [ait_llm-0.2.1-py3-none-linux_x86_64.whl](https://ais-bench.obs.cn-north-4.myhuaweicloud.com/compare/20240202/ait_llm-0.2.1-py3-none-linux_x86_64.whl)        | 3b1a8045a133d5a63900638dddf90e49 | [llm大模型推理精度工具功能说明_v0.2.1](../../docs/llm/llm大模型推理精度工具功能说明_v0.2.1.md) |
  |       |            |            |           |                                                                                                                                                            |                                  |                                                                                             |
