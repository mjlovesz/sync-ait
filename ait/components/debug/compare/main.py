...
from src.atc.atc_utils import AtcUtils
from src.common import utils
from src.common.utils import AccuracyCompareException, get_shape_to_directory_name, str2bool
from src.analyser import analyser
from src.net_compare.net_compare import NetCompare
from src.npu.npu_dump_data import NpuDumpData
from src.npu.npu_dump_data_bin2npy import data_convert
...
def _generate_golden_data_model(args):
    ...
    if ".pb" == extension:
        from src.tf.tf_dump_data import TfDumpData
        return TfDumpData(args)
    elif ".onnx" == extension:
        from src.onnx_model.onnx_dump_data import OnnxDumpData
