...
def run(args, input_shape, output_json_path, original_out_path, use_cli:bool):
    ...
    convert_npu_dump_data_path = data_convert(npu_dump_data_path, npu_net_output_data_path, args)

    # 4. generate dump data by golden model
    golden_dump_data_path = golden_dump.generate_dump_data(convert_npu_dump_data_path)
