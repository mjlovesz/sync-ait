...
- Install benchmark tool, refering [ais_bench](https://gitee.com/ascend/ait/tree/master/ait/components/benchmark/README.md)
...
| -c, --cann-path                          | CANN installation path, defaulted to **/usr/local/Ascend/ascend-toolkit/latest** if it is not found in the system environment. | No       |
