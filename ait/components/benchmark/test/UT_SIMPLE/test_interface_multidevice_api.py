...
# ====================test multi process infer iteration api==========================
    ...
    def test_infer_iteration_api_dymbatch_multidevice_batch_is_two(self):
        device_id = 0
        model_path = self.get_add_model_dynamic('dymbatch')
        multi_session = MultiDeviceSession(model_path)
    ...
    def test_infer_iteration_api_dymbatch_multidevice_batch_is_four(self):
        device_id = 0
        model_path = self.get_add_model_dynamic('dymbatch')
        multi_session = MultiDeviceSession(model_path)
    ...
    def test_infer_iteration_api_dymbatch_multidevice_batch_is_eight(self):
        device_id = 0
        model_path = self.get_add_model_dynamic('dymbatch')
        multi_session = MultiDeviceSession(model_path)
    ...
    def test_infer_iteration_api_dymbatch_multidevice_batch_is_sixteen(self):
        device_id = 0
        model_path = self.get_add_model_dynamic('dymbatch')
        multi_session = MultiDeviceSession(model_path)
