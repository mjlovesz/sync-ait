...
| [analyze](components/analyze/README.md)   | -                                       | 提供其他平台模型迁移至昇腾平台的支持度分析功能                 | ait analyze       |
| [transplt](components/transplt/README.md) | -                                       | 提供NV C++推理应用迁移分析以及昇腾API推荐功能             | ait transplt      |
