...
1. 仅设置--output参数。示例命令及结果如下：
  ...
  ```bash
  ait profile benchmark --model ./pth_resnet50_bs1.om --output ./result
  ```
...
2. 设置--input和--output参数。示例命令及结果如下：
  ...
  ```bash
  ait profile benchmark --model ./pth_resnet50_bs1.om --input ./data --output ./result
  ```
...
3. 设置--output_dirname参数。示例命令及结果如下：
  ...
  ```bash
  ait profile benchmark --model ./pth_resnet50_bs1.om --output ./result --output_dirname subdir
  ```
...
4. 设置--dump参数。示例命令及结果如下：
  ...
  ```bash
  ait profile benchmark --model ./pth_resnet50_bs1.om --output ./result --dump 1
  ```
...
5. 设置--profiler参数。示例命令及结果如下：
  ...
  ```bash
  ait profile benchmark --model ./pth_resnet50_bs1.om --output ./result --profiler 1
  ```
